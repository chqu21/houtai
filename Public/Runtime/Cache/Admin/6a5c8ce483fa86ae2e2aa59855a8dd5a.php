...
<!--编辑头像-->
<div id="admin_teacherlist_edit_photo_dialog" class="easyui-dialog" title="编辑老师头像" data-options="modal:true,closed:true,iconCls:'icons-application-application_edit',buttons:[{text:'关闭',iconCls:'icons-arrow-cross',handler:function(){$('#admin_teacherlist_edit_photo_dialog').dialog('close');}}]" style="width:750px;height:550px;"></div>
...
function adminAppraiseEdit(id){
    ...
    var url = '<?php echo U('Teacher/appraise');?>';
    url += url.indexOf('?') != -1 ? '&id='+id : '?id='+id;
