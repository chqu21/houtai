...
function adminteacherlistEditDialogFormSubmit(){
	$.post('<?php echo U('Student/studentEdit?id='.$info['teacher_id']);?>', $("#admin_teacherlist_edit_dialog_form").serialize(), function(res){
		if(!res.status){
...
<table class="gridtable">
    ...
    <tr>
        <td>密码：</td>
        <td><input id="admin_teacherlist_add_dialog_form_password" type="password" name="info[password]" value="" style="width:180px;height:22px" /></td>
