...
<param name="flashvars" value="imgUrl=<?php echo ($headPhoto["bigPic"]); ?>&uploadUrl=/index.php/admin/teacher/upfile?teacherId=<?php echo ($teacherId); ?>&uploadSrc=false" />
<EMBED src="../flash/avatar.swf" quality=high bgcolor=#FFFFFF WIDTH="650" HEIGHT="450" wmode="transparent" flashVars="imgUrl=<?php echo ($headPhoto["bigPic"]); ?>&uploadUrl=/index.php/admin/teacher/upfile?teacherId=<?php echo ($teacherId); ?>&uploadSrc=false"
